...
// Problem & context supporting image — controller mounted on the compressor.
import problemContext from '../../assets/industrial-hmi/problem-context.webp'
...
const CONTRIBUTION = [
  {
    label: 'Owned',
    body: 'The operator-facing information hierarchy, the state-first home framework, and the 34-component controller UI system.',
  },
  {
    label: 'Collaborated',
          ...
          <div className="cs-sections" ref={sectionsRef}>
            ...
            <section className="cs-section hmi-section" id="overview">
              {/* Split hero — shared cs-v2-hero-row: copy left (fixed 440px),
                  exhibit right. Same primitive Cooperant/Mochitta use. */}
              <div className="cs-v2-hero-row">
                <div className="cs-v2-hero-copy">
                  <p className="cs-label">INDUSTRIAL HMI, MACHINE CONTROLLER</p>
                  ...
                  <div className="cs-chip-row">
                    {META_CHIPS.map(({ label, value }) => (
                      <div key={value} className="cs-chip">
                        <p className="cs-chip__label">{label}</p>
                        <p className="cs-chip__value">{value}</p>
                      </div>
                    ))}
                  </div>
                  <div className="hmi-pill-row">
                    <span className="hmi-pill"><span className="hmi-pill__dot" />In production · 4+ yrs</span>
                  </div>
                </div>
                <div className="hmi-hero-visual">
                  <div className="hmi-hero-frame">
            ...
            <section className="cs-section hmi-section" id="problem">
              <div className="hmi-problem-grid">
                <div>
                  <p className="hmi-eyebrow">Problem &amp; context</p>
                ...
                <div className="hmi-problem-copy">
                  ...
                  <p className="hmi-lead">
                    Trip and maintenance states sat below the routine numbers an operator reads all day, so a machine heading toward a fault could go unnoticed until it faulted: downtime, or a hazard, not just friction. I mapped what an operator needs to catch <em className="hmi-em hmi-em--italic">first</em>, and rebuilt the home hierarchy around machine state.
                  </p>
                </div>
              </div>
              <div className="hmi-problem-figure">
                <img src={problemContext} alt="The machine controller mounted on an industrial air compressor" loading="lazy" decoding="async" />
              </div>
            </section>

            {/* 2 — Outcomes */}
            <section className="cs-section hmi-section" id="outcomes">
              <p className="hmi-eyebrow">Outcome</p>
            ...
            <section className="cs-section hmi-section" id="constraints">
              <p className="hmi-eyebrow">Constraints</p>
            ...
            <section className="cs-section hmi-section" id="decisions">
              <p className="hmi-eyebrow">Key decisions</p>
            ...
            <section className="cs-section hmi-section" id="system">
              <p className="hmi-eyebrow">Design systems</p>
              <h2 className="hmi-section-heading">
                One dark system where color is never decoration.
              </h2>
              <p className="hmi-lead hmi-system-lead">
                A reserved safety palette, monospaced numerics that hold at a glance, plain-language state labels, and targets sized for gloves on resistive hardware.
              </p>
              <div className="hmi-panel">
            ...
            <section className="cs-section hmi-section" id="shipped">
              <p className="hmi-eyebrow">What shipped</p>
              ...
              <div className="cs-quote hmi-quote">
                ...
                <div className="cs-quote__text">
                  ...
                  <p className="cs-quote__quote hmi-quote__quote">
                    Validated through 3 rounds of field and dealer review across all three display sizes: legibility under glare, gloved operation, alarm comprehension, and whether the state-first hierarchy held at 4.3″, 7″, and 10.1″.
                  </p>
                  <p className="hmi-eyebrow hmi-quote__eyebrow hmi-quote__eyebrow--next">What&rsquo;s next</p>
                  <p className="cs-quote__quote hmi-quote__quote">
                    Extending the state-first model to the fleet layer, where the same question (&ldquo;what needs me first?&rdquo;) scales from one machine to a whole plant.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="cs-section">
              ...
              <div className="cs-viewnext-grid">
                {getViewNext('industrial-hmi').slice(0, isMobile ? 1 : 2).map(({ id, video, title, compact }) => (
